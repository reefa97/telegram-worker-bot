...
export default function QualityControlPanel({ searchTerm = '' }: { searchTerm?: string }) {
    ...
    return (
        <div>
            ...
            {/* Sub-tabs */}
            <div className="flex bg-subtle p-1 rounded-lg mb-6 w-fit border border-border overflow-x-auto max-w-full">
                <button
            ...
            {activeSubTab === 'checks' && (
                <div>
                        ...
                        <div className="mb-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                                {todayScheduled.map(s => {
                                    ...
                                    if (!obj) return null;
                                    return (
                                        <div key={s.id} className="bg-card rounded-xl border-2 border-yellow-300 dark:border-yellow-600 p-5 shadow-sm hover:shadow-md transition-all">
                                            <h4 className="font-bold text-main text-lg">{obj.name}</h4>
                    ...
                    <h3 className="text-lg font-semibold text-main mb-4">Все объекты</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 mb-8">
                        {filteredObjects.map(obj => (
                            <div key={obj.id} className="bg-card rounded-xl border border-border p-5 shadow-sm hover:shadow-md transition-all">
                                <h4 className="font-bold text-main">{obj.name}</h4>
                                <p className="text-sm text-muted mt-1 flex items-center gap-1">
                                    <MapPin className="w-3.5 h-3.5" /> {obj.address}
                                </p>
                                <button
                    ...
                    {checks.length > 0 && (
                        <div>
                            <h3 className="text-lg font-semibold text-main mb-4">История проверок</h3>
                                    ...
                                    {checks.map(c => (
                                        <div key={c.id} className="flex items-center justify-between px-4 py-3">
                                            <div className="min-w-0 flex-1">
                                                <div className="font-medium text-main text-sm truncate">{getObjectName(c.object_id)}</div>
            ...
            {activeSubTab === 'schedules' && (
                <div>
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="text-lg font-semibold text-main">Графики проверок</h3>
                        {isSuperAdmin && (
                            <button
                    ...
                    {schedules.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                            {schedules.map(s => {
                                ...
                                return (
                                    <div key={s.id} className={`bg-card rounded-xl border ${cardBorder} p-5 shadow-sm transition-all`}>
                                        {/* Alert banner */}
                                        {isAlert && (
                                        ...
                                        <div className="flex justify-between items-start">
                                            <div>
                                                <h4 className="font-bold text-main">{getObjectName(s.object_id)}</h4>
                                                <p className="text-sm text-muted mt-1 flex items-center gap-1">
                                        ...
                                        {s.last_check_date && (
                                            <p className={`text-xs mt-1 ${isAlert ? 'text-red-500 dark:text-red-400 font-medium' : 'text-muted'}`}>
                                        ...
                                        {isSuperAdmin && isAlert && (
                                            <div className="mt-3 flex gap-2">
                                                <button
                                                    ...
                                                    className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg text-xs font-medium bg-primary/5 text-blue-700 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/40 border border-blue-200 dark:border-blue-800 transition-colors"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg text-xs font-medium bg-gray-50 dark:bg-gray-700 text-muted hover:bg-gray-100 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600 transition-colors"
                                                >
                                        ...
                                        <div className="mt-4 flex gap-2 pt-3 border-t border-gray-100 dark:border-gray-700/50">
                                            ...
                                            {isSuperAdmin && (
                                                <button
                                                    ...
                                                    className="flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg text-xs font-medium bg-gray-50 dark:bg-gray-700 text-muted hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                ...
                <div>
                    ...
                    <div className="flex justify-between items-center mb-4">
                        <p className="text-sm text-muted">
                            Найдено: <span className="font-semibold text-main">{historyTotal}</span> проверок
                        </p>
                    </div>
                                ...
                                {historyChecks.map(c => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`bg-card rounded-xl border border-border border-l-4 ${scoreBorder} p-5 shadow-sm hover:shadow-lg transition-all cursor-pointer group`}
                                        >
                                            <div className="flex justify-between items-start">
                                                <div className="flex-1 min-w-0">
                                                    <h4 className="font-bold text-main truncate">{getObjectName(c.object_id)}</h4>
                                                    <p className="text-sm text-muted mt-1 flex items-center gap-1">
                                            ...
                                            {c.notes && (
                                                <p className="mt-2 text-xs text-muted line-clamp-2 italic">💬 {c.notes}</p>
                                            )}
                            ...
                            {historyTotal > PAGE_SIZE && (
                                <div className="flex items-center justify-center gap-3">
                                    <button
                                        ...
                                        className="p-2 rounded-lg bg-gray-100 dark:bg-gray-700 text-muted hover:bg-gray-200 dark:hover:bg-gray-600 disabled:opacity-30 transition-colors"
                                    >
                    ...
                    <div className="modal-content sm:max-w-lg" onClick={e => e.stopPropagation()}>
                            ...
                            <div className="flex items-center gap-1">
                                {isSuperAdmin && (
                                    <button
                                        ...
                                        className="btn-icon text-danger hover:text-danger hover:bg-danger/10"
                        ...
                        <div className="modal-body">
                            ...
                            <div className="bg-gray-50 dark:bg-gray-700/30 rounded-xl p-4 mb-5">
                                <h4 className="font-bold text-main">{getObjectName(detailCheck.object_id)}</h4>
                                <p className="text-sm text-muted mt-1 flex items-center gap-1">
                            ...
                            {detailItems.length > 0 && (
                                <div className="mb-5">
                                    <h4 className="text-sm font-semibold text-main mb-3">Чек-лист ({detailItems.filter(i => i.is_passed).length}/{detailItems.length})</h4>
                                    <div className="space-y-2">
                                        {detailItems.map(item => (
                                            <div key={item.id}>
                                                <div
                                                    className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm ${item.is_passed
                                                        ? 'bg-green-50 dark:bg-green-900/10 text-main'
                            ...
                            {detailCheck.notes && (
                                <div className="mb-5">
                                    <h4 className="text-sm font-semibold text-main mb-2">Примечание</h4>
                                    <div className="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-3 text-sm text-main italic">
                                        💬 {detailCheck.notes}
                                    </div>
                                </div>
                            )}
                    ...
                    <div className="modal-content sm:max-w-md" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="modal-body">
                            ...
                            <div className="space-y-4">
                                {/* Object */}
                                <div>
                                    <label className="block text-sm font-medium text-main mb-1.5">Объект</label>
                                    <select
                                ...
                                {/* Manager */}
                                <div>
                                    <label className="block text-sm font-medium text-main mb-1.5">Доп. проверяющий <span className="text-gray-400 font-normal">(необязательно)</span></label>
                                    <select
                                ...
                                {/* Day of week */}
                                <div>
                                    <label className="block text-sm font-medium text-main mb-1.5">День недели</label>
                                ...
                                {/* Frequency */}
                                <div>
                                    <label className="block text-sm font-medium text-main mb-1.5">Частота</label>
                                    <select
            ...
            {showCheckModal && checkObject && createPortal(
                <div className="modal-overlay" onClick={() => setShowCheckModal(false)}>
                    <div className="modal-content sm:max-w-lg" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="modal-body">
                            <p className="text-sm text-muted mb-6">{checkObject.name} — {checkObject.address}</p>
                                ...
                                {checkItems.map((item, idx) => (
                                    <div key={idx}>
                                        ...
                                        >
                                            ...
                                            <span className="flex-1 text-sm font-medium text-main">{item.task_name}</span>
                                            {/* Camera button */}
                                            <button
                                                onClick={(e) => {
                                                    e.stopPropagation();
                            ...
                            <div className="flex gap-2 mb-6">
                                ...
                                <button
                                    ...
                                    className="bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 px-3 py-2 rounded-lg text-muted transition-colors disabled:opacity-50"
                                >
                                    <Plus className="w-4 h-4" />
                                </button>
                            </div>
                            ...
                            {/* Notes */}
                            <div className="mb-6">
                                <label className="block text-sm font-medium text-main mb-1.5">Заметки</label>
                                <textarea
                                    value={checkNotes}
