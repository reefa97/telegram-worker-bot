...
export default function ShiftDetailsModal({ session, onClose, onUpdate }: ShiftDetailsModalProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fadeIn overflow-hidden">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col animate-scaleIn border border-gray-100 dark:border-gray-700">

                {/* Header */}
                <div className="p-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-start bg-gray-50/50 dark:bg-gray-800/50 rounded-t-2xl">
                    <div>
                        ...
                        {session.workers?.phone_number && (
                            <a
                                ...
                                className="flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400 mt-2 hover:text-primary-600 dark:hover:text-primary-400 transition-colors w-fit"
                            >
                                <Phone size={14} />
                                {session.workers.phone_number}
                            </a>
